...
public partial class GameEntity {
    ...
    public void AddView(UnityEngine.GameObject newGameObject, UnityEngine.SpriteRenderer newSprite) {
    ...
    public void ReplaceView(UnityEngine.GameObject newGameObject, UnityEngine.SpriteRenderer newSprite) {
        var index = GameComponentsLookup.View;
        var component = CreateComponent<ViewComponent>(index);
        component.gameObject = newGameObject;
        component.sprite = newSprite;
